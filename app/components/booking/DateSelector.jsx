...
const DateSelector = ({ selectedDates, onDatesChange }) => {
  ...
  const [selectedRange, setSelectedRange] = useState({ start: 5, end: 31 });
  ...
  return (
    <View className="px-4 py-6">
      ...
      <View className="flex-row items-center justify-between mb-6">
        <TouchableOpacity onPress={() => console.log('⬅️ Previous month')}>
          <Feather name="chevron-left" size={24} color="white" />
        </TouchableOpacity>
        <Text className="text-white text-lg font-semibold">July 2024</Text>
        <TouchableOpacity onPress={() => console.log('➡️ Next month')}>
